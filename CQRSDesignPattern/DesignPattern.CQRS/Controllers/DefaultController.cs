...
namespace DesignPattern.CQRS.Controllers
{
    public class DefaultController : Controller
    {
        ...
        {
            _removeProductCommandHandler.Handle(new DeleteProductCommand(id));
            return RedirectToAction("Index");
        }
        [HttpGet]
